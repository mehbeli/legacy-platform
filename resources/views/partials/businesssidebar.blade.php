<button class="btn btn-success btn-block btn-open-order">Open Order</button>
<div class="list-group in-menu">
    ...
    <a href="{{ url('/business/'.$business->id.'/products') }}" class="list-group-item {{ Ekko::isActiveRoute('business.products.*') }}"><i class="fa fa-fw fa-reorder"></i> Products & Stocks</a>
    ...
    <a href="{{ url('/business/'.$business->id.'/invoices') }}" class="list-group-item {{ Ekko::isActiveRoute('business.invoices.*') }}"><i class="fa fa-fw fa-briefcase"></i> Invoices</a>
